...
const paths: Record<NavIcon, string> = {
  ...
  brain: "M12 2a7 7 0 00-4.6 12.3A4.98 4.98 0 0012 22a4.98 4.98 0 004.6-7.7A7 7 0 0012 2zm0 4a1 1 0 110 2 1 1 0 010-2zm-2 5h4m-2-2v4",
  bell: "M18 8a6 6 0 10-12 0c0 7-3 9-3 9h18s-3-2-3-9M13.73 21a2 2 0 01-3.46 0",
  file: "M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8l-6-6zm-2 0v6h6M8 13h8m-8 4h8",
